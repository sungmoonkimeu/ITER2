...
V_I = loadtxt('fig16_saved.dat',unpack=True, usecols=[0])
DataIN = loadtxt('fig16_saved.dat',unpack=True, usecols=[1,2,3,4,5])

LB = [0.0132]
SR = [0.003]
chi = [0.000, 0.003, 0.006, 0.009, 0.012]
strr = ['0,003 mm','0,003 mm','0,006 mm','0,009 mm','0,012 mm']
