...
ax[0].plot(data[data.head(0).columns[0]],data[data.head(0).columns[5]],lw='1', label='AO2015(2)',color='k')
...
ax[1].plot(data[data.head(0).columns[0]],data[data.head(0).columns[6]],lw='1', label='AO2015(2)',color='k')
